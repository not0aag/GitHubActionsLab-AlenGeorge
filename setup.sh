#!/bin/bash
# GitHub Actions Lab #4 - Quick Setup Script (Git Bash)
# Student: Alen George (991716469)
#
# This script helps you set up the Git repository
# Run this AFTER creating your GitHub repository on github.com
#
# IMPORTANT: Edit YOUR_USERNAME before running!
